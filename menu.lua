...
function scene:create( event )
	...
	local title = display.newImageRect( sceneGroup, "title.png", display.contentWidth, 80 )
	...
	local highScoresButton = display.newText( sceneGroup, "High Scores", display.contentCenterX, (display.contentCenterY*1.5+128), native.systemFont, 64 )
